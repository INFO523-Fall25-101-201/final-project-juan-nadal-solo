...
**Budget Inaccuracies:**
For example, Robert Downey Jr. appeared in the 1987 movie Less Than Zero where the dataset showed a $1 budget with 20 million in revenue, making the ROI appear abnormally high. Many smaller films lacked any budget information, making comparisons unreliable.
...
This normalized success across scales and time periods.
...
Improved access to IMDb Pro or verified compensation databases could refine results further.
...
* Social media follower count as emerging star power proxy.
