...
Other factors include budget, release timing, and genre. Each contributed less than 4% to the ROI prediction.
...
**Red One (2024):**
Even with Dwayne Johnson and Chris Evans, the film underperformed with an ROI of (–25.6%), underscoring that celebrity alone cannot rescue weak storytelling.

**Argylle (2024):**
Despite an ensemble cast, the movie ROI was (–55.8%), showing diminishing returns when high costs meet poor narrative reception.
...
* Prioritize proven stars (200%+ historical ROI).
...
* Social media followers count as an emerging star power proxy.
